...
def add_beta(NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS, extra_samplers):
    ...
    NODE_CLASS_MAPPINGS.update({
        ...
        "ClownOptions_SDE_Beta_Randomized": samplers_extensions.ClownOptions_SDE_Beta_Randomized,
        "ClownOptions_DetailBoost_Beta"   : samplers_extensions.ClownOptions_DetailBoost_Beta,
        "ClownOptions_DetailBoost_Beta_Randomized"   : samplers_extensions.ClownOptions_DetailBoost_Beta_Randomized,
        ...
        "ClownOptions_SigmaScaling_Beta_Randomized"  : samplers_extensions.ClownOptions_SigmaScaling_Beta_Randomized,
    ...
    NODE_DISPLAY_NAME_MAPPINGS.update({
            ...
            "ClownOptions_SDE_Beta_Randomized"              : "ClownOptions SDE Randomized",
            "ClownOptions_StepSize_Beta"                    : "ClownOptions Step Size",
            "ClownOptions_DetailBoost_Beta"                 : "ClownOptions Detail Boost",
            "ClownOptions_DetailBoost_Beta_Randomized"      : "ClownOptions Detail Boost Randomized",
            "ClownOptions_SigmaScaling_Beta"                : "ClownOptions Sigma Scaling",
            "ClownOptions_SigmaScaling_Beta_Randomized"     : "ClownOptions Sigma Scaling Randomized",
