...
class ClownOptions_SDE_Beta_Randomized:
    ...
    def INPUT_TYPES(cls):
        return {"required":
                    {
                    "lock_types":             ("BOOLEAN",                    {"default": False,                                                          "tooltip": "Whether to use manual selection for noise types or not"}), 
                    "lock_modes":             ("BOOLEAN",                    {"default": False,                                                          "tooltip": "Whether to use manual selection for noise mode or not"}), 
                    ...
                    "eta_max":                ("FLOAT",                      {"default": 0.6, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip": "Calculated noise amount to be added, then removed, after each step. DEFAULT ETA = 0.5"}),
                    "eta_substep_min":        ("FLOAT",                      {"default": 0.1, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip": "Calculated noise amount to be added, then removed, after each step. DEFAULT ETA = 0.5"}),
                    "eta_substep_max":        ("FLOAT",                      {"default": 0.6, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip": "Calculated noise amount to be added, then removed, after each step. DEFAULT ETA = 0.5"}),
...
class ClownOptions_DetailBoost_Beta_Randomized:
    ...
    def INPUT_TYPES(cls):
        return {"required":
                    ...
                    "lock_modes":    ("BOOLEAN", {"default": False,  "tooltip": "Lock noise scaling mode selection"}),
                    ...
                    "weight_min":    ("FLOAT", {"default": 0.6, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip":"Set to positive values to create a sharper, grittier, more detailed image. Set to negative values to soften and deepen the colors. DEFAULT = 1.0"}),
                    "weight_max":    ("FLOAT", {"default": 1.0, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip":"Set to positive values to create a sharper, grittier, more detailed image. Set to negative values to soften and deepen the colors. DEFAULT = 1.0"}),
                    ...
                    "eta_max":       ("FLOAT", {"default": 0.6, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip":"Determines whether the sampler or the model underestimates the noise level. DEFAULT = 0.5"}),
                    "start_step":    ("INT", {"default": 1, "min": 0, "max": MAX_STEPS}),
                    "end_step":      ("INT", {"default": 5, "min": -1, "max": MAX_STEPS}),
                    "seed":          ("INT", {"default": -1, "min": -1, "max": 0xffffffffffffffff}),
                    },
                "optional": 
                    {
...
class ClownOptions_SigmaScaling_Beta_Randomized:
    ...
    def INPUT_TYPES(cls):
        return {"required":
                    {
                    "s_noise_min":           ("FLOAT", {"default": 1.00, "min": -10000, "max": 10000, "step":0.01, "tooltip": "Adds extra SDE noise. Values around 1.03-1.07 can lead to a moderate boost in detail and paint textures. DEFAULT = 1"}),
                    "s_noise_max":           ("FLOAT", {"default": 1.02, "min": -10000, "max": 10000, "step":0.01, "tooltip": "Adds extra SDE noise. Values around 1.03-1.07 can lead to a moderate boost in detail and paint textures. DEFAULT = 1"}),
                    "s_noise_substep_min":   ("FLOAT", {"default": 1.00, "min": -10000, "max": 10000, "step":0.01, "tooltip": "Adds extra SDE noise. Values around 1.03-1.07 can lead to a moderate boost in detail and paint textures. DEFAULT = 1"}),
                    "s_noise_substep_max":   ("FLOAT", {"default": 1.02, "min": -10000, "max": 10000, "step":0.01, "tooltip": "Adds extra SDE noise. Values around 1.03-1.07 can lead to a moderate boost in detail and paint textures. DEFAULT = 1"}),
                    "noise_anchor_min":      ("FLOAT", {"default": 0.98, "min": -100.0, "max": 100.0, "step":0.01, "round": False, "tooltip": "Typically set to between 1.0 and 0.0. Lower values cerate a grittier, more detailed image. DEFAULT = 1"}),
                    ...
                    "lying_min":             ("FLOAT", {"default": 1.0, "min": -10000, "max": 10000, "step":0.01, "tooltip": "Downscales the sigma schedule. Values around 0.98-0.95 can lead to a large boost in detail and paint textures. DEFAULT = 1"}),
                    ...
                    "lying_inv_max":         ("FLOAT", {"default": 1.02, "min": -10000, "max": 10000, "step":0.01, "tooltip": "Upscales the sigma schedule. Will soften the image and deepen colors. Use after d_noise to counteract desaturation. DEFAULT = 1"}),
                    "lying_start_step":      ("INT", {"default": 5, "min": 0, "max": MAX_STEPS}),
                    "lying_inv_start_step":  ("INT", {"default": 10, "min": 0, "max": MAX_STEPS}),
                    "seed":                  ("INT", {"default": -1, "min": -1, "max": 0xffffffffffffffff}),
                    },
                "optional": 
                    {
    ...
    def main(self,
            s_noise_min: float = 1.00,
            s_noise_max: float = 1.02,
            s_noise_substep_min: float = 1.00,
            s_noise_substep_max: float = 1.02,
            noise_anchor_min: float = 0.98,
            noise_anchor_max: float = 1.0,
            lying_min: float = 1.0,
            lying_max: float = 1.0,
            lying_inv_min: float = 1.0,
            lying_inv_max: float = 1.02,
            lying_start_step: int = 5,
            lying_inv_start_step: int = 10,
            seed: int = -1,
