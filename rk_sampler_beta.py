                ...
                for diag_iter in range(implicit_steps_diag+1):
                    ...
                    if extra_options_flag("guide_pseudoimplicit_eps_proj_substep", extra_options):
                        ...
                        if step == 0:
                            ...
                            eps_tmp_, x_tmp_      = LG.process_guides_substep(x_0, x_, eps_,      data_, row-1, step, sigma, sigma_next, sigma_down, s_, unsample_resample_scale, rk, rk_type, extra_options, frame_weights_grp)
                            eps_substep_guide = eps_tmp_[row]
