...
from .legacy_sampler_rk import sample_rk_legacy
...
class Legacy_ClownsharKSampler:
    ...
    def main(self, model, cfg, truncate_conditioning, sampler_mode, scheduler, steps, denoise=1.0, denoise_alt=1.0,
            ...
            sampler = comfy.samplers.ksampler("rk_legacy", {"eta": eta, "eta_var": eta_var, "s_noise": s_noise, "d_noise": d_noise, "alpha": alpha_sde, "k": k_sde, "c1": c1, "c2": c2, "c3": c3, "cfgpp": cfgpp, "MULTISTEP": multistep, 
